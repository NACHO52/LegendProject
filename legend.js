...
alert('Corrés velozmente para alcanzarlo, no podes ver su rostro por lo cubre con un trapo de color negro y azul. ' + 
...
if(choise2 === 'robar') {
    heroPlayer.gold + 450;
    alert('Excelente decición. Has conseguido ' + heroPlayer.gold + ' monedas de oro.')
